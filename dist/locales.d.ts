 ...
 */
export declare const RETAIL_MCP_LANGS: readonly ["en", "ru", "es", "pt-BR", "fr", "de", "it", "nl", "tr", "ar", "he", "hi", "zh-CN", "ja", "ko", "th"];
export type RetailMcpLang = (typeof RETAIL_MCP_LANGS)[number];
